...
void MVM_6model_bootstrap(MVMThreadContext *tc) {
    ...
    /* Create stub VMNull, VMDeleted, BOOTInt, BOOTNum, BOOTStr, BOOTArray, BOOTHash,
...
#define create_stub_boot_type(tc, reprid, slot, makeboolspec, boolspec) do { \
    ...
    create_stub_boot_type(tc, MVM_REPR_ID_MVMDeleted, VMDeleted, 0, MVM_BOOL_MODE_NOT_TYPE_OBJECT);
...
#define meta_objectifier(tc, slot, name) do { \
    ...
    meta_objectifier(tc, VMDeleted, "VMDeleted");
