...
static void MVM_io_populate_sig_values(MVMThreadContext *tc, MVMint8 *sig_vals) {
...
static void MVM_io_populate_instance_valid_sigs(MVMThreadContext *tc, MVMint8 *sig_vals) {
...
MVMObject * MVM_io_get_signals(MVMThreadContext *tc) {
    ...
    MVM_io_populate_sig_values(tc, sig_wanted_vals);
    ...
    MVMROOT(tc, sig_hash, {
        ...
        MVM_io_populate_instance_valid_sigs(tc, sig_wanted_vals);
    });
